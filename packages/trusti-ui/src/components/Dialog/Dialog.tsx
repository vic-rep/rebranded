  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-full max-w-lg',
        'bg-[var(--background)] border border-[var(--border)] rounded-[var(--radius)] shadow-xl',
        'p-6',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-[family-name:var(--font-heading)] font-semibold text-lg text-[var(--foreground)]', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-sm text-[var(--foreground-muted)] font-[family-name:var(--font-body)]', className)}
    {...props}
  />
))
