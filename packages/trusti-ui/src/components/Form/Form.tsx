  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <p
        ...
        className={cn('text-xs text-[var(--foreground-muted)] font-[family-name:var(--font-body)]', className)}
        {...props}
      />
    )
  }
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <p
        ref={ref}
        id={formMessageId}
        className={cn('text-xs font-medium text-red-500 font-[family-name:var(--font-body)]', className)}
        {...props}
      >
        {body}
      </p>
