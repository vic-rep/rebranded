  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="font-[family-name:var(--font-body)] leading-relaxed mt-6"
          style={{
        ...
        <p
          className="font-[family-name:var(--font-body)] font-semibold tracking-wide mt-5"
          style={{
            fontSize: '0.875rem',
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {vps.map((vp) => (
            <div key={vp.heading} className="flex flex-col gap-3">
              <div
